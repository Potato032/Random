         ...
         if entityModel.Parent and not entityModel:GetAttribute("NoAI") then 
             ...
             if playerInSight then 
                 ...
                 -- Kill player 
                     ...
                     task.spawn(function() 
 if workspace.Ambience_FigureEnd.Playing or workspace.Ambience_Seek.Playing or workspace:FindFirstChild("Blink") or workspace:FindFirstChild("SeekMoving") then
 return 
 end 
                         ...
                         ReSt.GameStats["Player_".. Plr.Name].Total.DeathCause.Value = Daunt
